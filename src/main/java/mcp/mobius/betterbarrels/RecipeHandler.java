...
public class RecipeHandler {
    ...
    public static RecipeHandler instance() {
        return RecipeHandler._instance;
    }
    ...
    public void registerRecipes() {
        ...
        GameRegistry.addRecipe(
                new ShapedOreRecipe(
                        new ItemStack(BetterBarrels.blockBarrel),
                        new Object[] { "W-W", "WCW", "WWW", Character.valueOf('C'), "chestWood", Character.valueOf('W'),
                                "logWood", Character.valueOf('-'), "slabWood" }));

        GameRegistry.addRecipe(
                new ShapedOreRecipe(
                        new ItemStack(BetterBarrels.itemMover, 1, 0),
                        new Object[] { "  X", " PX", "XXX", Character.valueOf('X'), "ingotIron", Character.valueOf('P'),
                                "plankWood" }));

        if (BetterBarrels.diamondDollyActive) {
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            new ItemStack(BetterBarrels.itemMoverDiamond, 1, 0),
                            new Object[] { "   ", " P ", "XXX", Character.valueOf('X'), "gemDiamond",
                                    Character.valueOf('P'), BetterBarrels.itemMover }));
        }

        GameRegistry.addRecipe(
                new ShapedOreRecipe(
                        new ItemStack(BetterBarrels.itemHammer, 1, 0),
                        new Object[] { "III", "ISI", " S ", Character.valueOf('I'), "ingotIron", Character.valueOf('S'),
                                "stickWood" }));

        GameRegistry.addRecipe(
                new ShapedOreRecipe(
                        new ItemStack(BetterBarrels.itemTuningFork, 1, 0),
                        new Object[] { " P ", " EP", "P  ", Character.valueOf('P'), "ingotIron", Character.valueOf('E'),
                                Items.ender_pearl }));
    ...
    public void registerLateRecipes() {
        try {
            ...
            BetterBarrels.log.error(
                    "Requested item with id " + BetterBarrels.upgradeItemStr
                            + " for tier upgrade recipes was not found, using the default of vanilla fence");
            upgradeItem = new ItemStack(Blocks.fence);
        }

        for (int i = 0, max = Math.min(StructuralLevel.LEVELS.length - 1, BetterBarrels.maxCraftableTier); i
                < max; i++) {
    ...
    private void addCoreUpgradeUpgradeReverse(int resultMeta, int sourceMeta) {
        GameRegistry.addRecipe(
                new ShapelessOreRecipe(
                        new ItemStack(BetterBarrels.itemUpgradeCore, 3, sourceMeta),
    ...
    private void addStructuralUpgrade(int level, Object variableComponent) {
        GameRegistry.addRecipe(
                new ShapedOreRecipe(
                        new ItemStack(BetterBarrels.itemUpgradeStructural, 1, level),
                        new Object[] { "PBP", "B B", "PBP", Character.valueOf('P'), upgradeItem, Character.valueOf('B'),
                                variableComponent }));
    }
    ...
    private void addCoreUpgrade(int meta, Object variableComponent) {
        GameRegistry.addRecipe(
                new ShapedOreRecipe(
                        new ItemStack(BetterBarrels.itemUpgradeCore, 1, meta),
                        new Object[] { " P ", " B ", " P ", Character.valueOf('P'), Blocks.piston,
    ...
    private void addSideUpgrade(int meta, Object center, Object border) {
        GameRegistry.addRecipe(
                new ShapedOreRecipe(
                        new ItemStack(BetterBarrels.itemUpgradeSide, 4, meta),
                        new Object[] { " P ", "PBP", " P ", Character.valueOf('P'), border, Character.valueOf('B'),
                                center }));
    }
}
