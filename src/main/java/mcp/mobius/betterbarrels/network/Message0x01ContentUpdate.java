...
public class Message0x01ContentUpdate extends SimpleChannelInboundHandler<Message0x01ContentUpdate>
    ...
    protected void channelRead0(ChannelHandlerContext ctx, Message0x01ContentUpdate msg) throws Exception {
        ...
        if (barrel != null) barrel.getStorage().setStoredItemType(msg.stack, msg.amount);
    }
}
